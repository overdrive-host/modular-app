import { initializeApp, getApps, getApp } from "https://www.gstatic.com/firebasejs/9.6.8/firebase-app.js";
import { getAuth, onAuthStateChanged, setPersistence, browserLocalPersistence } from "https://www.gstatic.com/firebasejs/9.6.8/firebase-auth.js";
import { getFirestore, collection, addDoc, getDocs, doc, updateDoc, deleteDoc, query, orderBy, limit, startAfter, getDoc, writeBatch, where } from "https://www.gstatic.com/firebasejs/9.6.8/firebase-firestore.js";
                        ...
                        saveEditBtn.addEventListener('click', async () => {
                            ...
                            try {
                                ...
                                batch.update(refRef, {
                                    ...
                                    lastAction: `Actualizado: ${formatDate(now)}`,
                                    uid: auth.currentUser.uid
                                });
                                const logRef = doc(collection(db, 'referencias', refRef.id, 'logs'));
                                batch.set(logRef, {
                                    action: `Actualizado: ${formatDate(now)}`,
                    ...
                    if (confirmDeleteBtn) {
                        confirmDeleteBtn.addEventListener('click', async () => {
                            ...
                            try {
                                ...
                                batch.set(logRef, {
                                    action: `Eliminado: ${formatDate(now)}`,
