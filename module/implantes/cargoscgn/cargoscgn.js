    ...
    function setupEventListeners() {
        ...
        document.querySelectorAll('.filter-icon').forEach(icon => {
            icon.addEventListener('click', (e) => {
                ...
                const currentFilter = document.querySelector(`input[data-column="${column}"]`);
                if (currentFilter) {
                    currentFilter.replaceWith(input);
                } else {
        ...
        document.addEventListener('click', (e) => {
            if (!e.target.classList.contains('filter-icon') && !e.target.classList.contains('filter-input')) {
                document.querySelectorAll('.filter-input').forEach(input => input.remove());
            }
        });
    }
