...
try {
    ...
    function setupColumnResizing() {
        const headers = document.querySelectorAll('#historico-table th.resizeable');
        headers.forEach(th => {
                ...
                try {
                    ...
                    for (let i = 1; i < jsonData.length; i++) {
                        ...
                        const registro = {
                            ...
                            importOrder: i - 1, // Índice basado en el orden de importación
                    ...
                    if (skippedRows > 0) {
                        message += `. ${skippedRows} fila(s) vacía(s) o sin ID_PACIENT fueron ignoradas.`;
                    }
